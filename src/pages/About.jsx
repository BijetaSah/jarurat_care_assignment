    ...
    <div className="">
      ...
      <div className="p-6 lg:px-30 flex flex-col gap-5 items-center lg:py-10">
        ...
        <p className="text-center mt-2 lg:text-lg">
          ...
          offering unwavering support every step of the way. We’re a
          community-driven NGO dedicated to bringing hope, care, and strength to
          patients, caregivers, and healthcare professionals across India.
        </p>
        <button className=" px-6 hover:cursor-pointer py-2 text-white capitalize font-semibold rounded-full bg-blue-600 text-lg hover:bg-white hover:text-blue-700 hover:border hover:border-blue-700 transition-all duration-200 text-center">
